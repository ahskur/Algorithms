public class HappyNumbers {
    public static boolean isHappy(int n) {
        ...
        // und die Anzahl an Zyklen, der das programm laufen soll.
        // Falls die Anzahl überschritten wird, sofort abbrechen, weil der Wert nie fröhlich sein wird
        int iterations = 0;
        int sum = 0;
        // Schleife läuft, solange der angegebene Wert 1 ist, bis es eine Lösung (fröhlich oder nicht) gefunden würde
        while (n > 0) {
            System.out.println(n);
            // Jedes Mal, das eine Ziffer getestet wird, 1 an die Anzahl an Zyklen addieren
            iterations++;
            // Hole letzten Ziffer von n (immer von rechts nach links z.B: 82 → Erst 2 wird angerechnet, dann 8)
            int ziffer = n % 10;
            ...
            // Letzte Ziffer von n fällt weg, weil es schon quadriert und summiert würde
            n = n / 10;
